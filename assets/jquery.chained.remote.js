        ...
        return this.each(function () {
            ...
            $(settings.parents).each(function () {
                $(this).bind("change", function () {
                    ...
                    /* Do not execute remote request if the data is empty. Always executes if the children were not previously cleaned. */
                    if (!settings.clear_children || !$.isEmptyObject(data)) {
